...
Success.prototype.ap = function (other) {
  return other.isSuccess ? other.map(this.value) : other;
};

Failure.prototype.ap = function (other) {
  return other.isFailure ? Failure.of(this.value.concat(other.value)) : this;
};
...
Validation.coerse = function (x) {
  return !x ? Success.of(x) : x.isSuccess ? x : x.isFailure ? x : Success.of(x);
};
